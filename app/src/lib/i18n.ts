...
const MESSAGES = {
  ja: {
    ...
    // ダッシュボード
    "dash.myIssues": "自分のタスク",
    "dash.myPullRequests": "自分のプルリクエスト",
    "dash.recentUpdates": "最近の更新",
    "dash.recentlyViewed": "最近見たタスク",
    "dash.savedFilters": "保存した検索条件",
    "dash.noIssues": "該当するタスクはありません",
    "dash.noPullRequests": "開いているプルリクエストはありません",
    "dash.noUpdates": "まだ更新はありません",
    "dash.noProjects": "参加しているプロジェクトはありません",
    "dash.empty": "まだありません",
    "dash.showAll": "全 {count} 件を表示",
    "dash.roleAssigned": "担当",
    "dash.roleCreated": "登録",
    "dash.dueAll": "全て",
    "dash.dueWithin4Days": "4日以内",
    "dash.dueToday": "今日まで",
    "dash.dueOverdue": "期限切れ",

    // 進捗（本家に無い機能。決定 D29）
    "progress.doneOf": "{done} / {total} 件完了",
    "progress.inProgress": "進行中 {count}",
    "progress.notStarted": "未対応 {count}",
    "progress.overdue": "期限切れ {count}",
    "progress.byHours": "予定時間ベース {percent}%",
    "progress.noIssues": "タスクなし",
    "progress.legend": "完了 {done} / 進行中 {doing} / 未対応 {open}（全 {total} 件）",

    // プロジェクトのサイドバー
    "project.home": "ホーム",
    "project.addIssue": "タスクの追加",
    "project.issues": "タスク",
    "project.board": "ボード",
  ...
  en: {
    ...
    "dash.myPullRequests": "My pull requests",
    "dash.recentUpdates": "Recent updates",
    "dash.recentlyViewed": "Recently viewed issues",
    "dash.savedFilters": "Saved filters",
    "dash.noIssues": "No matching issues",
    "dash.noPullRequests": "No open pull requests",
    "dash.noUpdates": "No updates yet",
    "dash.noProjects": "You are not in any project",
    "dash.empty": "Nothing yet",
    "dash.showAll": "Show all {count}",
    "dash.roleAssigned": "Assigned",
    "dash.roleCreated": "Created",
    "dash.dueAll": "All",
    "dash.dueWithin4Days": "Within 4 days",
    "dash.dueToday": "Due today",
    "dash.dueOverdue": "Overdue",

    "progress.doneOf": "{done} of {total} done",
    "progress.inProgress": "In progress {count}",
    "progress.notStarted": "Open {count}",
    "progress.overdue": "Overdue {count}",
    "progress.byHours": "By estimated hours {percent}%",
    "progress.noIssues": "No issues",
    "progress.legend": "Closed {done} / In progress {doing} / Open {open} (of {total})",
